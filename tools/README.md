...
| [`red-strike/`](red-strike/) | **1.1 / Plan 01** | ✅ Pin 0.6.0 (`bd3aa96`) | **Only Plan 01 / CADRE-assessment engine.** Copy features from sister `RedStrike\`; graphs/missions stay in CADRE. |
