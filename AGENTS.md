...
**Current Session (2026-08-03 — Campaign H initial access set up + 5/6 verified live; 3.5G DPAPI VERIFIED end-to-end via updated SharpDPAPI):**
- **Updated tool builds merged (2026-08-03):** consolidated tool copies to ws01 `C:\Tools\ADTools\tools-2026\` (dup tree removed). Unique/newer builds: **SharpDPAPI (2026-02-02)**, Rubeus (2026-02-16), DCOMRunAs, Keycred, chromelevator_x64, SharpADWS, SOAPHound, SharpGPOAbuse, PPLBlade (deobfuscate.py + pypykatz.exe), DSInternals_v5.3, EntraConnectAbuse, InviShell, Powermad.
- **3.5G → ✅ VERIFIED end-to-end (2026-08-03):** the updated SharpDPAPI **imports our cadre domain DPAPI PVK without `Bad Version of provider`** — blocker was tool-version, not platform. Full chain on dc01 (WinRM as DA): backup key → masterkeys decrypted (Administrator `{07024635…}:624FE5B4…`, chief_command `{9cdd94c1…}:094F1372…`) → **real blobs decrypted** (Administrator Credential `DFBE70A7…` + Web Credentials Vault aes128/aes256 keys). Rollup: **119 = 82 ✅ / 10 ⚠️ / 10 ⏳ / 11 🔬 / 6 ❌**.
