...
PS1_LOCAL="${CAMPAIGN_A_LIB}/../windows/campaign-a-t101a-trustedhosts.ps1"
bash "${CAMPAIGN_A_LIB}/ws01-stage-file.sh" "${PS1_LOCAL}" "campaign-a-t101a-trustedhosts.ps1"

ws01_exec_as analyst_t1 'T13r_An@lyst!' \
  "powershell -NoProfile -ExecutionPolicy Bypass -File C:\\Tools\\cadre-attack\\campaign-a-t101a-trustedhosts.ps1"
