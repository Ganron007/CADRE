...
$TargetDn = "OU=Command,DC=cadre,DC=local"
$TargetName = "Command"

Write-Output "=== ACL grant: $RunAsUser grants $Principal $Rights on OU $TargetDn ==="
...
$searcher.Filter = "(&(objectClass=organizationalUnit)(name=$TargetName))"
