# Re-check: WS01 BGB signin + re-trigger CMPivot + poll — analyst_t1 (ws01)
$ErrorActionPreference = 'Continue'

Write-Output '=== [0] WS01 CcmNotificationAgent.log tail (signin?) ==='
Get-Content 'C:\Windows\CCM\Logs\CcmNotificationAgent.log' -Tail 12 -ErrorAction SilentlyContinue

Write-Output ''
Write-Output '=== [1] Trigger CMPivot on WS01 (16777220) via WMI as MBR02\vagrant ==='
