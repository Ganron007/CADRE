...
param(
    ...
    [string]$Payload = "C:\Windows\Temp\cadre-tools\campaign-a-t102-trigger-payload.ps1"
)
...
Copy-Item -Path "$PSScriptRoot\campaign-a-t102-trigger-payload.ps1" -Destination $Payload -ToSession $session -Force
Remove-PSSession $session
Write-Output "TRIGGER_PAYLOAD_STAGED"
