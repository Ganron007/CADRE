# CADRE — Learning Path (62 Walkthroughs)

Recommended sequence through all 62 CADRE walkthroughs, organized by skill progression. Start at Tier 1 regardless of certification target.

---

## Tier 1 — Recon & Enumeration (Easy, No Creds Needed)

**Overview:** No credentials required. These are the entry point to any AD assessment — identify users, passwords, and initial access vectors.

| WT# | Title | Difficulty | Est. Time |
|-----|-------|-----------|-----------|
| 028 | Null Session Enumeration | Easy | 20 min |
| 031 | Password Spray | Easy | 30 min |
