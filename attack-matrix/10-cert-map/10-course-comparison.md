...
| **CADRE WT** | 003, 004, 009, 010, 011, 012, 013, 015, 050 (ESC1) |
...
| **CADRE WT** | 002-033 (on-prem minus ~~028~~/~~031~~), 050-053, 055, 062 |
...
| **CADRE WT** | 008 (Shadow Credentials), 013-014 (ACL), 021 (NTLM relay), 050-062 (ESC) |
...
| **CADRE WT** | 002-048 (on-prem + MSSQL + Linux + SCCM, minus ~~028~~/~~031~~/~~018-020~~) |
...
| **CADRE WT** | 003, 009, 015, 022, 032, 040, 041, 043 (~~028~~ ❌, ~~031~~ ⏳) |
